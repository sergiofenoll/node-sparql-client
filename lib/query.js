...
Query.prototype.executeRaw = function () {
...
Query.prototype.execute = function() {
  ...
  this.executeRaw(arguments).then(response => {
    ...
    var responseBody = maybeParseJSON(response.body);

    if (options)
      formatter.format(responseBody, options);
